  ...
  return (
    <div className="cart">
            ...
            return (
              <div key={index}>
                <div  className="cart-items-title cart-items-item">
                  ...
                  <img onClick={()=>removeFromCart(item._id)} className="cross-img" src={assets.cross_icon} alt="" />
                </div>
                <hr />
              </div>
            );
      ...
      <div className="policy">
        <h3 className="policy-title">Review your order and address details to avoid cancellations</h3>    
      <p className="policy-note"> <span>Note: </span>If you cancel within 60 seconds of placing your order, a 100% refund will be issued. No refund for cancellations made after 60 seconds.</p>
      <p className="policy-desc">Avoid cancellation as it leads to food wastage.</p>
      ...
      <div className="cart-bottom">
        <div className="cart-total">
          ...
          <div>
            ...
            <div className="cart-total-details">
              <p>Platform fee</p>
              <p> <span className="platfrom-fee">&#x20B9;5.00</span> &nbsp; 4</p>
            </div>
            <div className="cart-total-details">
            ...
            <div className="cart-total-details">
              ...
              <b>&#x20B9;{getTotalCartAmount() === 0 ? 0 :getTotalCartAmount()+84.+4+40}</b>
            </div>
          </div>
